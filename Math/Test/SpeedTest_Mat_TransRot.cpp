...
#ifdef NDEBUG
#define	numMat_TransRot 1000000
#else
#define	numMat_TransRot 1
#endif

TEST(SpeedTest_Mat_TransRot, TestConfig::ALL)
{
#if SpeedTest_Mat_TransRot
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	tA0.Tic();
	for (int i = 0; i < numMat_TransRot; i++)
	{
		*pOut = (*pA) * (*pB);
	}
	tA0.Toc();
	...
	Trace::out2("SpeedTest_Mat_TransRot  ratio: %f   (1.25) \n", ratio);
	CHECK(ratio > 1.25f);
#endif
#endif
