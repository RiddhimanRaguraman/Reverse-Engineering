...
#ifdef NDEBUG
#define	numMat_QuatMat4 1000000
#else
#define	numMat_QuatMat4 1
#endif

TEST(SpeedTest_Mat_QuatMat4, TestConfig::ALL)
{
#if SpeedTest_Mat_QuatMat4
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	tA0.Tic();
	for (int i = 0; i < numMat_QuatMat4; i++)
	{
		*pOut = (*pA) * (*pB);
	}
	tA0.Toc();
	...
	Trace::out2("SpeedTest_Mat_QuatMat4  ratio: %f   (1.15)\n", ratio );
	CHECK(ratio > 1.15f);
#endif
#endif
