...
#ifdef NDEBUG
#define	numMat_ScaleTrans 1000000
#else
#define	numMat_ScaleTrans 1
#endif

TEST(SpeedTest_Mat_ScaleTrans, TestConfig::ALL)
{
#if SpeedTest_Mat_ScaleTrans

	Trans B(3.0f, 5.0f, 8.0f);
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	tA0.Tic();
	for (int i = 0; i < numMat_ScaleTrans; i++)
	{
		*pOut = (*pA) * (*pB);
	}
	tA0.Toc();
	...
	Trace::out2("SpeedTest_Mat_ScaleTrans  ratio: %f    (1.5) \n", ratio );
	CHECK(ratio > 1.5f);
#endif
#endif
