...
#ifdef NDEBUG
#define	numINVScale 1000000
#else
#define	numINVScale 1
#endif
...
TEST(SpeedTestInv_Scale, TestConfig::ALL)
{
#if SpeedTestInv_Scale
	...
	Trace::out2("SpeedTestInv_Scale  ratio: %f   (2.0)\n", ratio);
	CHECK(ratio > 2.0f);
#endif
#endif
