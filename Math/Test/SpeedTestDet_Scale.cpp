...
#ifdef NDEBUG
#define	numDETScale 10000000
#else
#define	numDETScale 1
#endif

TEST(SpeedTestDet_Scale, TestConfig::ALL)
{
#if SpeedTestDet_Scale
	...
	*pOut2 = pA2->det();
	...
	Trace::out2("SpeedTestDet_Scale  ratio: %f   (1.5)\n", ratio);
	CHECK(ratio > 1.5f);
#endif
#endif
