...
#ifdef NDEBUG
#define	numDETTrans 10000000
#else
#define	numDETTrans 1
#endif

TEST(SpeedTestDet_Trans, TestConfig::ALL)
{
#if SpeedTestDet_Trans
	...
	*pOut2 = pA2->det();
	...
	Trace::out2("SpeedTestDet_Trans  ratio: %f   (1.5)\n", ratio	);
	CHECK(ratio > 1.5f);
#endif
#endif
