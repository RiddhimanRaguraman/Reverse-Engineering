...
#ifdef NDEBUG
#define	numMat_RotRot 1000000
#else
#define	numMat_RotRot 1
#endif

TEST(SpeedTest_Mat_RotRot, TestConfig::ALL)
{
#if SpeedTest_Mat_RotRot
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	Trace::out2("SpeedTest_Mat_RotRot ratio: %f   (1.25)\n", ratio );
	CHECK(ratio > 1.25f);
#endif
#endif
