...
#ifdef NDEBUG
#define	numMat_RotScale 1000000
#else
#define	numMat_RotScale 1
#endif

TEST(SpeedTest_Mat_RotScale, TestConfig::ALL)
{
#if SpeedTest_Mat_RotScale
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	tA0.Tic();
	for (int i = 0; i < numMat_RotScale; i++)
	{
		*pOut = (*pA) * (*pB);
	}
	tA0.Toc();
	...
	Trace::out2("SpeedTest_Mat_RotScale  ratio: %f   (1.25) \n", ratio );
	CHECK(ratio > 1.25f);
#endif
#endif
