...
#ifdef NDEBUG
#define	numINVRotTrans 1000000
#else
#define	numINVRotTrans 1
#endif

TEST(SpeedTestInv_RotTrans, TestConfig::ALL)
{
#if SpeedTestInv_RotTrans
	...
	tA0.Tic();
	for(int i = 0; i < numINVRotTrans; i++)
	{
		*pB = pA->getInv();
	}
	tA0.Toc();
	...
	//Trace::out("    Rotate Translate -> M = R * T; \n");
	...
	Trace::out2("SpeedTestInv_RotTrans  ratio: %f  (2.0) \n", ratio);
	CHECK(ratio > 2.0f);
#endif
#endif
