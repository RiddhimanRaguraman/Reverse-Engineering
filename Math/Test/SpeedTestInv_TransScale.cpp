...
#ifdef NDEBUG
#define	numINVTransScale 1000000
#else
#define	numINVTransScale 1
#endif

TEST(SpeedTestInv_TransScale, TestConfig::ALL)
{
#if SpeedTestInv_TransScale
	...
	tA0.Tic();
	for(int i = 0; i < numINVTransScale; i++)
	{
		*pB = pA->getInv();
	}
	tA0.Toc();
	...
	Trace::out2("SpeedTestInv_TransScale  ratio: %f   (2.0)\n", ratio);
	CHECK(ratio > 2.0f);
#endif
#endif
