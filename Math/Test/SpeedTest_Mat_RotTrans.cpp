...
#ifdef NDEBUG
#define	numMat_RotTrans 1000000
#else
#define	numMat_RotTrans 1
#endif

TEST(SpeedTest_Mat_RotTrans, TestConfig::ALL)
{
#if SpeedTest_Mat_RotTrans
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	tA0.Tic();
	for (int i = 0; i < numMat_RotTrans; i++)
	{
		*pOut = (*pA) * (*pB);
	}
	tA0.Toc();
