...
#ifdef NDEBUG
#define	numMat_ScaleScale 1000000
#else
#define	numMat_ScaleScale 1
#endif

TEST(SpeedTest_Mat_ScaleScale, TestConfig::ALL)
{
#if SpeedTest_Mat_ScaleScale

	Scale B(3.0f, 5.0f, 8.0f);
	...
	*pOut2 = (*pA2) * (*pB2);
	...
	tA0.Tic();
	for (int i = 0; i < numMat_ScaleScale; i++)
	{
		*pOut = (*pA) * (*pB);
	}
	tA0.Toc();
